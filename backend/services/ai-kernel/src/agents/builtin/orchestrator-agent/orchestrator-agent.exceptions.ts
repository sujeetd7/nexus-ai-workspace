export class OrchestratorAgentException extends Error {
  ...
  constructor(operation?: string, message?: string) {
    super(message || `Orchestrator agent operation${operation ? ` '${operation}'` : ''} failed`);
...
export class InvalidOrchestratorOperationException extends Error {
  ...
  constructor(operation: string, reason: string, message?: string) {
    super(message || `Invalid orchestrator operation '${operation}': ${reason}`);
    this.operation = operation;
    this.reason = reason;
    Object.setPrototypeOf(this, InvalidOrchestratorOperationException.prototype);
  }
}
...
export class WorkflowExecutionAgentException extends Error {
  ...
  constructor(workflowId: string, reason: string, message?: string) {
    super(message || `Workflow execution failed for '${workflowId}': ${reason}`);
...
export class AgentOrchestratorUnavailableException extends Error {
  ...
  constructor(message?: string) {
    ...
    Object.setPrototypeOf(this, AgentOrchestratorUnavailableException.prototype);
  }
}
...
export class InvalidOrchestratorExecutionRequestException extends Error {
  ...
  constructor(missingFields: string[], message?: string) {
    super(message || `Invalid execution request - missing fields: ${missingFields.join(', ')}`);
    this.missingFields = missingFields;
    Object.setPrototypeOf(this, InvalidOrchestratorExecutionRequestException.prototype);
  }
}