...
export const env = {
  ...
  NOTIFICATION_SERVICE_URL: process.env.NOTIFICATION_SERVICE_URL ?? "http://localhost:3011",
  ANALYTICS_SERVICE_URL: process.env.ANALYTICS_SERVICE_URL ?? "http://localhost:3012",
